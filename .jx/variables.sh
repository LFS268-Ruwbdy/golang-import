...
export DOCKER_REGISTRY_ORG='playground-321017'
export DOMAIN='104.197.200.246.nip.io'
export GIT_BRANCH='main'
export JENKINS_X_URL='http://dashboard-jx.104.197.200.246.nip.io/LFS268/golang-import/main/1'
...
export MINK_IMAGE='gcr.io/playground-321017/golang-import:0.0.1'

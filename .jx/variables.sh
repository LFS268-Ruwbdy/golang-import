...
export DOCKER_REGISTRY_ORG='ci-cd-x2'
export DOMAIN='34.171.216.180.nip.io'
export GIT_BRANCH='main'
export JENKINS_X_URL='http://dashboard-jx.34.171.216.180.nip.io/LFS268-Ruwbdy/golang-import/main/1'
...
export MINK_IMAGE='gcr.io/ci-cd-x2/golang-import:0.0.4'
...
export REPO_OWNER='LFS268-Ruwbdy'
